...
const ProductDetails = () => {
    ...
    const { products, navigate, currecy, addToCart } = useAppContext()
    const { id } = useParams()
        ...
        <div className="mt-12">
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                <div className="flex gap-3">
                    ...
                    <div className="flex flex-col gap-3">
                        {product.image.map((image, index) => (
                            <div
                                ...
                                className="border border-gray-300 rounded overflow-hidden cursor-pointer w-20 h-20"
                            >
                                <img
                                    src={image}
                    ...
                    {/* Main Image */}
                    <div
                        className="border border-gray-300 rounded overflow-hidden w-[400px] h-[400px]"
                        onMouseMove={(e) => {
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            <img src={i < 4 ? assets.star_icon : assets.dull_star_icon} alt="" className='md:w-4 w-3.5' />
                    ...
                    <div className="mt-6">
                        <p className="text-gray-500/70 line-through">MRP: ${currecy}{product.price}</p>
