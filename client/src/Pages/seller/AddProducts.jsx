...
import { assets, categiries } from '../../assets/assets'
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mt-2">
            {Array(4).fill('').map((_, index) => (
              <label key={index} htmlFor={`image${index}`}>
                ...
                <img className="max-w-15 cursor-pointer border border-primary" src={files[index] ? URL.createObjectURL(files[index]) : assets.upload} alt="uploadArea" width={100} height={100} />
                <p className='cursor-pointer text-primary'>Upload</p>
              </label>
            ))}
          </div>
        </div>
